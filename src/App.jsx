...
function App() {
  ...
  return (
    <div className="flex w-full h-screen items-center justify-center bg-gray-500">
      <div className="w-full max-w-md h-[300px] mx-auto shadow-md rounded-lg px-4 py-3 my-8 bg-gray-800 text-white-500">
        <h1 className="text-white text-center text-3xl my-8">
          Password generator
        </h1>
        <div className="flex shadow h-[50px] rounded-lg overflow-hidden mb-4">
          <input
            type="text"
            value={password}
